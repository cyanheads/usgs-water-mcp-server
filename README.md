...
| `USGS_USER_AGENT` | Custom User-Agent string sent to USGS NWIS. USGS requests a descriptive User-Agent per their terms. | `usgs-water-mcp-server/0.1.2 (contact: https://github.com/cyanheads/usgs-water-mcp-server)` |
